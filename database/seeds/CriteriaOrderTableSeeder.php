...
class CriteriaOrderTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        CriteriaOrder::create(['user_id'=>2, 'place_type_id'=>1,'criterion_id'=>1,'display_order'=>1]);
        CriteriaOrder::create(['user_id'=>2, 'place_type_id'=>1,'criterion_id'=>2,'display_order'=>2]);
        CriteriaOrder::create(['user_id'=>2, 'place_type_id'=>1,'criterion_id'=>6,'display_order'=>3]);
        CriteriaOrder::create(['user_id'=>2, 'place_type_id'=>1,'criterion_id'=>4,'display_order'=>4]);
    }
}
